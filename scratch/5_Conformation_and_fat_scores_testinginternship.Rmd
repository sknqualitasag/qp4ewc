---
title: "Testing the function pre_process_ew_input_carcass_data_flp()"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Testing the function pre_process_ew_input_carcass_data_flp()}
...
Testing the function `pre_process_ew_input_carcass_data_flp()`. The task of this function is to pre-process the carcass conformation, fat, prices based on different input like flp-data, prices to update the input-parameter-file of ECOWEIGHT.
...
s_input_file_flp_carcass_matrix_statement <- "/Users/skn/muku_Ecoweigth/2022/data/internship/input_flp_carcass_matrix_statement_LM_NB.txt"
...
s_input_file_price_cow <- "/Users/skn/muku_Ecoweigth/2022/data/internship/cow_price_LM_NB.txt"
# Path to input with bull price. Based on this example an other file can be created with different input-values.
s_input_file_price_bull <- "/Users/skn/muku_Ecoweigth/2022/data/internship/bull_price_LM_NB.txt"
# Path to input with heifer price. Based on this example an other file can be created with different input-values.
s_input_file_price_heifer <- "/Users/skn/muku_Ecoweigth/2022/data/internship/heifer_price_LM_NB.txt"
