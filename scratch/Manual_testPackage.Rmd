...
s_path_directory2create <- "/Users/skn/muku_Ecoweigth/2022/test_package/work"
...
s_input_file_literature <- "/Users/skn/muku_Ecoweigth/2022/test_package/par/input_literature_ewbc.txt"
...
s_input_file_par <- "/Users/skn/muku_Ecoweigth/2022/test_package/par/input_par_statement_ewbc.txt"
# Path to input from the calving. Based on this example an other file can be created with different input-values.
s_input_file_calving_statement <- "/Users/skn/muku_Ecoweigth/2022/test_package/par/input_calving_statement_ewbc.txt"
# Path to calving data file
s_input_file_calving <- "/Users/skn/muku_Ecoweigth/2022/test_package/data/test_ANAUCHLMSIOB_zws_muku_gal.csv"
...
s_input_file_progeny_flp_statement <- "/Users/skn/muku_Ecoweigth/2022/test_package/par/input_flp_statement_ewbc.txt"
# Path to flp data file
s_input_file_flp <- "/Users/skn/muku_Ecoweigth/2022/test_package/data/test_ANAUCHLMSIOB_zws_muku_flp.csv"
# Path to input statement for carcass and price
s_input_file_flp_carcass_matrix_statement <- "/Users/skn/muku_Ecoweigth/2022/test_package/par/input_flp_carcass_matrix_statement_ewbc.txt"
# Path to input with cow price. Based on this example an other file can be created with different input-values.
s_input_file_price_cow <- "/Users/skn/muku_Ecoweigth/2022/test_package/par/cow_price_ewbc.txt"
# Path to input with bull price. Based on this example an other file can be created with different input-values.
s_input_file_price_bull <- "/Users/skn/muku_Ecoweigth/2022/test_package/par/bull_price_ewbc.txt"
# Path to input with heifer price. Based on this example an other file can be created with different input-values.
s_input_file_price_heifer <- "/Users/skn/muku_Ecoweigth/2022/test_package/par/heifer_price_ewbc.txt" 
...
More processing steps will follow here ...
