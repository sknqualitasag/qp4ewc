...
s_dambreed <- "HO"
# Production system according to ECOWEIGHT for beef-on-dair: 4 corresponding to dairy
s_prodsystew <- "4"
# Marketing channel can be: ConventionalBeef, ConventionalVeal corresponding to intensiv fattening system for beef or veal
