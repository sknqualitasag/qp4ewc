...
s_path_directory2create <- file.path(here::here(),"inst","extdata","ewdc","results")
...
# Path to calving data file #### !!!! Making specific test file for beef-on-dairy
...
```{r}
#Path to files
path_results_files <- "~/Ecoweight_package/qp4ewc/inst/extdata/ewdc/results"
# Path to output statements from the results file of ewdc
s_output_statement <- "~/Ecoweight_package/qp4ewc/inst/extdata/ewdc/output_statement.txt"
# Path to search patterns needed to find correct results 
s_output_search_pattern <- "~/Ecoweight_package/qp4ewc/inst/extdata/ewdc/output_searchpattern.txt"
# Path to save table of result 
s_path_tbl_save <- "~/Ecoweight_package/qp4ewc/inst/extdata/ewdc/results"
