...
s_path_directory2create <- file.path(here::here(),"inst", "extdata", "ewdc", "Ecoweight_output")
...
s_input_file_flp <- file.path(here::here(),"inst","extdata","ewbc","test","zws_muku_flp.csv")
# Path to calf price data file.
s_input_file_calf <- file.path(here::here(),"inst","extdata","ewbc","test","test_calf_data.csv")
...
```{r}
#Path to files
path_results_files <- file.path(here::here(),"inst", "extdata", "ewdc", "Ecoweight_output")
# Path to output statements from the results file of ewdc
s_output_statement <-  file.path(here::here(),"inst", "extdata", "ewdc", "output_statement.txt")
# Path to search patterns needed to find correct results 
s_output_search_pattern <- file.path(here::here(),"inst", "extdata", "ewdc", "output_searchpattern.txt")
# Path to genetic standard deviation values 
s_input_genetic_SD <- file.path(here::here(),"inst", "extdata", "ewdc", "input_geneticSD.txt")
# Path to save table of result 
s_path_tbl_save <- file.path(here::here(),"inst", "extdata", "ewdc", "results")
...
sort by sire: 
```{r}
# How you want the tables to be organised. one table per sire breed (sire_breed), one table per dam breed (dam_breed) or one table per marketing channel (marketing_channel)
s_sort_by = "sire_breed"
# Path to the results tables printed from the post_processing_ewdc_output function above
s_path_results_tbl <-  file.path(here::here(),"inst", "extdata", "ewdc", "results")
...
s_path_save <-   file.path(here::here(),"inst", "extdata", "ewdc", "results")
