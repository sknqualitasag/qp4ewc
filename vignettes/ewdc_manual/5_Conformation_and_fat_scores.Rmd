...
In the flp-data-file are the carcass data readed. With the `s_start_flp_date` and `s_end_flp_date` , the time frame of the flp-data to consider is set.
...
update_input_parameter_file(ps_path2template_input_parameter_file = file.path(s_path_directory2create,paste0(s_sirebreed,"_",s_dambreed,"_",s_prodsystew,"_",s_marketingchannel),tbl_input_statement_flp_carcass[11,1]),
...
update_input_parameter_file(ps_path2template_input_parameter_file = file.path(s_path_directory2create,paste0(s_sirebreed,"_",s_dambreed,"_",s_prodsystew,"_",s_marketingchannel),tbl_input_statement_flp_carcass[12,1]),
...
update_input_parameter_file(ps_path2template_input_parameter_file = file.path(s_path_directory2create,paste0(s_sirebreed,"_",s_dambreed,"_",s_prodsystew,"_",s_marketingchannel),tbl_input_statement_flp_carcass[1,1]),
...
```{r}
# base price for cow
update_input_parameter_file(ps_path2template_input_parameter_file = file.path(s_path_directory2create,paste0(s_sirebreed,"_",s_dambreed,"_",s_prodsystew,"_",s_marketingchannel),tbl_input_statement_flp_carcass[4,1]),
...
```{r}
# average price bull
update_input_parameter_file(ps_path2template_input_parameter_file = file.path(s_path_directory2create,paste0(s_sirebreed,"_",s_dambreed,"_",s_prodsystew,"_",s_marketingchannel),tbl_input_statement_flp_carcass[5,1]),
...
```{r}
# basis price bull
update_input_parameter_file(ps_path2template_input_parameter_file = file.path(s_path_directory2create,paste0(s_sirebreed,"_",s_dambreed,"_",s_prodsystew,"_",s_marketingchannel),tbl_input_statement_flp_carcass[6,1]),
...
```{r}
# basis price heifer
update_input_parameter_file(ps_path2template_input_parameter_file = file.path(s_path_directory2create,paste0(s_sirebreed,"_",s_dambreed,"_",s_prodsystew,"_",s_marketingchannel),tbl_input_statement_flp_carcass[7,1]),
...
update_input_parameter_file(ps_path2template_input_parameter_file = file.path(s_path_directory2create,paste0(s_sirebreed,"_",s_dambreed,"_",s_prodsystew,"_",s_marketingchannel),tbl_input_statement_flp_carcass[8,1]),
